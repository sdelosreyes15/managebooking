		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#trainsdelosreyesmanagebooking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"trainsdelosreyesmanagebooking-display": {
								"semanticObject": "trainsdelosreyesmanagebooking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=train.sdelosreyes.managebooking",
									"url": sap.ui.require.toUrl("train/sdelosreyes/managebooking")
								}
							}
						}
					}
